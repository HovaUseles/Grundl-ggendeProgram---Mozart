...
namespace GrundlæggendeProgram___Mozart
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] chosenFiles = new string[32];
            string[,] menuetFiles = new string[11, 16]
            {
                ...
                {"54", "130", "10", "103", "28", "37", "106", "5", "35", "20", "108", "92", "12", "124", "44", "13" }
            };
            ...
            for (int i = 0; i < chosenFiles.Length; i++)
            {
                ...
                if (i <= 15)
                {
                    playPicker = rand.Next(0, 10);
                    chosenFiles[i] = menuetFiles[playPicker, i];
                }
                else
                {
                    playPicker = rand.Next(0, 5);
                    chosenFiles[i] = trioFiles[playPicker, i - 16];
                }
                Console.WriteLine(i+1 + " " + chosenFiles[i]);
            }
            for (int i =  0; i < chosenFiles.Length;i++)
            {
